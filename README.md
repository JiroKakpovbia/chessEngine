# chessEngine
![image](./preview.png)
This is a Chess engine created using C++. It was created as a final project in the University of Waterloo's CS 246 (Object-Oriented Software Development) course offered in Spring 2024. My other teammates for this project were Adam Muinuddin and Liam Knox.

The source code and our final Design Document are unavailable in this public repository, as public access would violate academic policies. If you would like to see the source code or the final Design document for this project, please email me at [kakpovbia.jiro@gmail.com] or [jjkakpov@uwaterloo.ca].

Below is the documentation containing the regulations for this assignment. Furthermore, there is a list of enhancements that I made individually after the assignment deadline had passed. Finally, the rules and instructions for this Chess Engine are found at the end of this document. Note that the instructions are different than those specified in the assignment documentation.
...
The project guidelines, specifically regarding Chess and instructions for playing the game, are [here](./docs/chess.pdf). Please note that modifications have been made, so the updated instructions can be found below.
...
4. Turn switches to the opponent once a piece is promoted
...
10. Added a tie due to insufficient pieces on the board
11. Fixed the  Check detection system
12. Added a detection system when someone is in check, displaying in text and graphical display
13. Computers no longer make moves that put themselves in check
14. Double check is now detected, which occurs when a piece is in check by 2 opposing pieces
15. Fixed long castling with Black pieces; now it is possible
...
18. Updated the resign command to prompt the user to play another game, resetting the board as well
19. Fixed the issue where Pawns would jump over pieces in a double forward move
...
'resign' concedes the game to your opponent. This is the only way, outside of winning or drawing, to end a game.
