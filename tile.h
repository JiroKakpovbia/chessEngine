...
class Tile {
  ...
  public:
    ...
    virtual bool simulateMove(const pair<int, int> &posn1, const pair<int, int> &posn2, const Board &board, Tile* piece); // Returns false if the simulated move doesn't put the player in check, true otherwise
};
